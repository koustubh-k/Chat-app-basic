...
// node_modules/react-emoji/dist/react-emoji.js
var require_react_emoji = __commonJS({
  "node_modules/react-emoji/dist/react-emoji.js"(exports, module) {
    !function(f, e) {
      "object" == typeof exports && "object" == typeof module ? module.exports = e(require_react()) : "function" == typeof define && define.amd ? define(["react"], e) : "object" == typeof exports ? exports.ReactEmoji = e(require_react()) : f.ReactEmoji = e(f.React);
    }(exports, function(f) {
      return function(f2) {
        function e(_) {
          if (a[_]) return a[_].exports;
          var o = a[_] = { exports: {}, id: _, loaded: false };
          return f2[_].call(o.exports, o, o.exports, e), o.loaded = true, o.exports;
        }
        var a = {};
        return e.m = f2, e.c = a, e.p = "", e(0);
      }([function(f2, e, a) {
        "use strict";
        var _ = function(f3) {
          return f3 && f3.__esModule ? f3.default : f3;
        }, o = _(a(6)), n = _(a(1)), t = _(a(2)), r = _(a(3)), i = _(a(5)), l = _(a(4)), c = function() {
          var f3 = function(f4) {
            return Object.keys(f4).map(function(f5) {
              return r(f5);
            }).join("|");
          }, e2 = function(f4) {
            var e3 = { useEmoticon: f4.useEmoticon !== false, emojiType: f4.emojiType || "twemoji", host: f4.host || "", path: f4.path || "", ext: f4.ext || "svg", singleEmoji: f4.singleEmoji || false, strict: f4.strict || false };
            return e3.attributes = i({ width: "20px", height: "20px" }, f4.attributes), e3;
          }, a2 = { ":/": "1f615" }, _2 = "\\:\\/(?!\\/)", c2 = { delimiter: new RegExp("(:(?:" + f3(n) + "):|" + f3(t) + "|" + _2 + ")", "g"), dict: i(n, t, a2) }, s = { delimiter: new RegExp("(:(?:" + f3(n) + "):)", "g"), dict: n }, d = function(f4, e3) {
            if (e3.host) return l([e3.host, e3.path, "" + f4 + "." + e3.ext]).join("/");
            if ("twemoji" === e3.emojiType) return "https://twemoji.maxcdn.com/" + e3.ext + "/" + f4 + "." + e3.ext;
            if ("emojione" === e3.emojiType) return "http://cdn.jsdelivr.net/emojione/assets/" + e3.ext + "/" + f4.toUpperCase() + "." + e3.ext;
            throw new Error("Invalid emojiType is passed");
          }, g = function(f4) {
            return f4.match(/^:.*:$/) ? f4.replace(/^:/, "").replace(/:$/, "") : f4;
          }, b = function(f4, e3) {
            var a3 = e3.useEmoticon ? c2 : s, _3 = a3.dict, n2 = _3[g(f4)];
            if (e3.strict && !n2) throw new Error("Could not find emoji: " + f4 + ".");
            return n2 ? o.createElement("img", i(e3.attributes, { src: d(n2, e3) })) : f4;
          }, u = function(f4, e3) {
            var a3 = e3.useEmoticon ? c2 : s, _3 = a3.delimiter, n2 = a3.dict;
            return l(f4.split(_3).map(function(f5, a4) {
              var t2 = f5.match(_3);
              if (e3.strict && "" !== f5 && null === t2) throw new Error("Could not find emoji: " + f5 + ".");
              if (t2) {
                var r2 = n2[g(t2[0])];
                return null === r2 ? f5 : o.createElement("img", i(e3.attributes, { key: a4, src: d(r2, e3) }));
              }
              return f5;
            }));
          };
          return { emojify: function(f4) {
            var a3 = void 0 === arguments[1] ? {} : arguments[1];
            return f4 ? (a3 = e2(a3), a3.singleEmoji ? b(f4, a3) : u(f4, a3)) : null;
          } };
        };
        f2.exports = c();
      }, function(f2, e) {
        ...
        "use strict";
        function a(f3) {
          if (null == f3) throw new TypeError("Object.assign cannot be called with null or undefined");
          return Object(f3);
        }
        f2.exports = Object.assign || function(f3, e2) {
          for (var _, o, n = a(f3), t = 1; t < arguments.length; t++) {
            _ = arguments[t], o = Object.keys(Object(_));
            for (var r = 0; r < o.length; r++) n[o[r]] = _[o[r]];
          }
          return n;
        };
      }, function(e, a) {
...
export default require_react_emoji();
